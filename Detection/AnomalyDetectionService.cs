...
namespace SecureTransparentDataExchange.AI.Detection
{
    public class AnomalyDetectionService
    {
        private static readonly MLContext _mlContext = new MLContext(seed: 1);

        public List<AnomalyDetectionResult> Detect(List<AnomalyDetectionRequest> request)
        {
            ...
            {
                Features = new float[] { x.Feature1, x.Feature2, x.Feature3 },
            ...
            var rawPredictions = _mlContext.Data
                .CreateEnumerable<AnomalyDetectionRawPrediction>(
                    transformed,
    ...
    public class AnomalyDetectionRawPrediction
    {
